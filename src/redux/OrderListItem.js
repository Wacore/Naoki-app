...
export const REMOVE_FROM_LIST = "orderListRemoved";

export const SET_ORDER_NUM = "orderNumSet";
export const SET_TYPE = "orderTypeSet";
export const SET_PEOPLE_NUM = "orderPeopleNumSet";
export const SET_TABLE_NUM = "orderTableNumSet";
...
export const SET_SELECTED_AMOUNT_MINUS = "selectedIDAmountMinus";
